...
import com.mkirilkin.doodlekong.databinding.ItemAnnouncementBinding
import com.mkirilkin.doodlekong.databinding.ItemChatMessageIncomingBinding
import com.mkirilkin.doodlekong.databinding.ItemChatMessageOutgoingBinding
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import ru.mkirilkin.doodlekong.data.remote.websocket.models.messages.Announcement
import ru.mkirilkin.doodlekong.data.remote.websocket.models.messages.BaseModel
import ru.mkirilkin.doodlekong.data.remote.websocket.models.messages.ChatMessage
import java.text.SimpleDateFormat
import java.util.*

private const val VIEW_TYPE_INCOMING_MESSAGE = 0
private const val VIEW_TYPE_OUTGOING_MESSAGE = 1
private const val VIEW_TYPE_ANNOUNCEMENT_MESSAGE = 2
...
class ChatMessageAdapter(
    ...
    private val dateFormat = SimpleDateFormat("kk:mm:ss", Locale.getDefault())
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            VIEW_TYPE_ANNOUNCEMENT_MESSAGE -> AnnouncementViewHolder(
    ...
    override fun getItemViewType(position: Int): Int {
        return when (val obj = chatObjects[position]) {
            is Announcement -> VIEW_TYPE_ANNOUNCEMENT_MESSAGE
            is ChatMessage -> {
            ...
            is AnnouncementViewHolder -> {
                ...
                holder.binding.apply {
                    ...
                    when (announcement.announcementType) {
                        ...
                        Announcement.TYPE_PLAYER_GUESSES_WORD -> {
